...
mock_insights = [
    {'icon': 'ALERT', 'message': '3 patients flagged with potential cardiac symptoms - auto-routed to Emergency', 'severity': 'high'},
    {'icon': 'WAIT', 'message': 'Medicine OPD wait time predicted to exceed 45 min in next 30 minutes. Recommend opening Counter 2.', 'severity': 'medium'},
    {'icon': 'PEAK', 'message': 'Peak hour predicted: 11:00 AM - 1:00 PM. Recommend 2 extra floor staff.', 'severity': 'low'},
]
